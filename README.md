...
- **On-chip soft-modem.** AFSK 1200 Bd Bell 202 (standard APRS) with up to three parallel demodulators (tilt-diversity prefilters, tunable from the web admin), plus AFSK 1200 Bd V.23, AFSK 300 Bd, and **G3RUH 9600 Bd FSK** — all in pure C on the ESP32's own ADC/DAC.
...
| Area | Notes |
|---|---|
| AFSK 1200 Bd Bell 202 | Up to three parallel demodulators, default profile |
