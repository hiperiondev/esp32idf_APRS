...
#define TR_RADIO_AUDIO_HW_INFO  "<br>DAC uscita: GPIO%d<br>ADC ingresso: GPIO%d<br>Pin PTT: %s<br>PTT attivo-alto: %s<br>Attenuazione ADC: %d<br>ADC: %d Hz<br>DAC: %d Hz"
...
#define TR_NOTE_BUDLIST "Elenco nominativi condiviso, fino a 8 voci. Lista Bianca: passano solo i nominativi elencati. Lista Nera: i nominativi elencati vengono bloccati."
...
#define TR_NOTE_RANGE_PREFIX "Filtro locale applicato solo a RF -> Internet, indipendente dal filtro per tipo di payload sopra. La distanza è misurata dalla posizione della Mia Stazione; i pacchetti la cui posizione non può essere decodificata non sono influenzati dal filtro di distanza."

#define TR_F_3RDPARTY_UNWRAP_EN "Inoltra traffico di terze parti (}) in lista bianca"
#define TR_NOTE_3RDPARTY_UNWRAP "Disattivato per impostazione predefinita. Ha effetto solo quando il Filtro Nominativi Internet verso RF sopra è impostato su Lista Bianca: un pacchetto incapsulato di terze parti viene decapsulato e inoltrato solo se il nominativo sorgente interno è a sua volta in lista bianca. Abilitare solo se ci si fida della fonte specifica e questa è stata inserita in lista bianca - ri-filtrare il traffico di terze parti senza questa restrizione è la causa più comune dei loop IGate."
