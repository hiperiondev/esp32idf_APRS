...
#define TR_NOTE_OBJITEM                                    "Los Objetos llevan marca de tiempo (;NOMBRE); los Ítems son permanentes ()NOMBRE). Al desmarcar Activo se envían reportes de eliminación y luego se deshabilita automáticamente. El Alcance limita la transmisión independientemente de las casillas RF/Internet."
...
#define TR_RADIO_AUDIO_HW_INFO  "<br>DAC salida: GPIO%d<br>ADC entrada: GPIO%d<br>Pin PTT: %s<br>PTT activo en alto: %s<br>Atenuación ADC: %d<br>ADC: %d Hz<br>DAC: %d Hz"
...
#define TR_NOTE_BUDLIST "Lista de indicativos compartida, hasta 8 entradas. Lista Blanca: solo pasan los indicativos listados. Lista Negra: los indicativos listados se bloquean."
...
#define TR_NOTE_RANGE_PREFIX "Filtro local aplicado solo a RF -> Internet, independiente del filtro por tipo de carga anterior. La distancia se mide desde la posición de Mi Estación; los paquetes cuya posición no se puede decodificar no se ven afectados por el filtro de distancia."

#define TR_F_3RDPARTY_UNWRAP_EN "Retransmitir tráfico de terceros (}) en lista blanca"
#define TR_NOTE_3RDPARTY_UNWRAP "Desactivado por defecto. Solo tiene efecto cuando el Filtro de Indicativos de Internet a RF anterior está en modo Lista Blanca: un paquete envuelto de terceros solo se desenvuelve y retransmite si su indicativo de origen interno está en la lista blanca. Active esto solo si confía en la fuente específica y la ha incluido en la lista blanca - volver a filtrar tráfico de terceros sin esta restricción es la causa más común de bucles de IGate."
