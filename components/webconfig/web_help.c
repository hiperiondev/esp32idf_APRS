...
static const struct {
    ...
    { TR_F_ADC_SELF_BIAS, TR_H_F_ADC_SELF_BIAS },
    ...
    { TR_F_APRS_PASSCODE, TR_H_F_APRS_PASSCODE },
    { TR_F_DAC_AMPLITUDE_PCT, TR_H_F_DAC_AMPLITUDE_PCT },
    { TR_F_DAC_SAMPLERATE, TR_H_F_DAC_SAMPLERATE },
    ...
    { TR_F_DUP_CACHE_EN, TR_H_F_DUP_CACHE_EN },
    ...
    { TR_F_ENABLE_AUDIO_MODEM, TR_H_F_ENABLE_AUDIO_MODEM },
    ...
    { TR_F_FLAT_AUDIO_INPUT, TR_H_F_FLAT_AUDIO_INPUT },
    ...
    { TR_F_OBJITEM_PERMANENT, TR_H_F_OBJITEM_PERMANENT },
    ...
    { TR_F_RX_CLIP_WARN, TR_H_F_RX_CLIP_WARN },
    ...
    { TR_F_TX_MAX_KEYED_MS, TR_H_F_TX_MAX_KEYED_MS },
    { TR_F_RX_EQ_PRESET, TR_H_F_RX_EQ_PRESET },
    { TR_F_RX_EQ_COUNT, TR_H_F_RX_EQ_COUNT },
    { TR_F_RX_TILT_1, TR_H_F_RX_TILT },
    { TR_F_RX_TILT_2, TR_H_F_RX_TILT },
    { TR_F_RX_TILT_3, TR_H_F_RX_TILT },
    { TR_F_RX_BPF_LO_HZ, TR_H_F_RX_BPF_LO_HZ },
    { TR_F_RX_BPF_HI_HZ, TR_H_F_RX_BPF_HI_HZ },
    { TR_F_RX_BPF_TAPS, TR_H_F_RX_BPF_TAPS },
    { TR_F_RX_GATE_MV, TR_H_F_RX_GATE_MV },
    { TR_F_RX_HPF_HZ, TR_H_F_RX_HPF_HZ },
    { TR_F_RX_AGC_MODE, TR_H_F_RX_AGC_MODE },
    { TR_F_RX_AGC_GAIN_DB, TR_H_F_RX_AGC_GAIN_DB },
    { TR_F_RX_FIX_BITS, TR_H_F_RX_FIX_BITS },
    ...
    { TR_SYS_RO_USERNAME, TR_H_SYS_RO_USERNAME },
