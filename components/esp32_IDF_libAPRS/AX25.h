...
/**
 * @brief Decode a raw AX.25 frame into the module-static message and invoke the registered hook
 */
void ax25_decode_default(uint8_t *buf, size_t len, uint16_t mVrms);

/**
 * @brief Decode a raw AX.25 frame into a caller-supplied AX25Msg
 */
