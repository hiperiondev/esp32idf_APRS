 ...
 */
typedef enum {
    APRS_COMPRESSION_ORIGIN_COMPRESSED = 0,    /**< binary 000: directly compressed by the originating device. */
    APRS_COMPRESSION_ORIGIN_TNC_BTEXT = 1,     /**< binary 001: TNC Beacon Text. */
    APRS_COMPRESSION_ORIGIN_SOFTWARE = 2,      /**< binary 010: software (DOS/Mac/Win/+SA). */
    APRS_COMPRESSION_ORIGIN_RESERVED_011 = 3,  /**< binary 011: reserved / to-be-defined. */
    APRS_COMPRESSION_ORIGIN_KPC3 = 4,          /**< binary 100: Kantronics KPC-3. */
    APRS_COMPRESSION_ORIGIN_PICO = 5,          /**< binary 101: Pico tracker. */
    APRS_COMPRESSION_ORIGIN_OTHER_TRACKER = 6, /**< binary 110: other tracker (to-be-defined). */
...
typedef struct {
     ...
     *          slot, so no slot can silently overlap another payload's
     *          memory.
     */
    size_t analog_count;
