...
.. list-table::
   ...
   * - POST
     - ``/radio/level``
     - misura il livello di ricezione, la polarizzazione di ingresso e il margine del convertitore e riporta le statistiche di ricezione, senza trasmettere (risultato JSON)
   * - POST
     - ``/radio/txtest``
